              ...
              <div className="film-card__reviews film-card__row">
                <div className="film-card__reviews-col">
                  <div className="review">
                    <blockquote className="review__quote">
                      <p className="review__text">
                        ...
                        of the director&rsquos funniest and most exquisitely designed
                        films in years.
                      </p>
                  ...
                  <div className="review">
                    <blockquote className="review__quote">
                      <p className="review__text">
                        Anderson&rsquos films are too precious for some, but for
                        those of us willing to lose ourselves in them, they&rsquore a
                        delight. &rdquoThe Grand Budapest Hotel&rdquo is no different,
                  ...
                  <div className="review">
                    <blockquote className="review__quote">
                      <p className="review__text">
                        I didn&rsquot find it amusing, and while I can appreciate the
                        creativity, it&rsquos an hour and 40 minutes I wish I could
                        take back.
                      </p>
                      <footer className="review__details">
